...
const WhyUsContent = ({ content }) => {
  ...
  return (
    <section
      className="w-full py-40 lg:py-10"
      id="WhyUs"
    >
      ...
      <div className="w-11/12 lg:w-10/12 mx-auto grid gap-1 items-center xl:flex">
        ...
        <div className="mt-15 lg:mt-0 block lg:hidden">

          <h2 className="text-5xl font-semibold text-[#0F5B81] mb-7">
            {heading}
          </h2>

          <h3 className="text-4xl font-semibold text-[#2A778D] mb-7">
            {sub_heading}
          </h3>
        ...
        <div
          className="w-11/12 mx-auto lg:w-8/12 xl:w-6/12 font-[inter] order-2 xl:order-1 mt-10"
