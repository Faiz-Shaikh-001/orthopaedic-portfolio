...
const AboutContent = ({ content }) => {
  ...
  return (
    <section
      className="relative -mt-30 lg:-mt-40"
      id="About"
    >
      <AboutTopBG
      ...
      <div className="relative bg-white -mt-1 py-10">
          ...
          <div className="text-right w-fit flex flex-col items-center lg:items-end fadeInAnim">
            ...
            <div className="relative w-[70%] lg:w-full">
              ...
              {imageUrl ? (
                ...
                <DoctorPlaceHolder className="drop-shadow-lg w-full h-fit" />
              )}

              <DoctorPlaceHolder className="opacity-30 absolute -z-1 top-6 left-6 w-full h-fit" />
        ...
        <div className="absolute pointer-events-none -right-[25%] top-[50%] lg:top-1/4 size-[50%] rounded-full bg-radial radial-[at_50%_75%] from-[#88CEC2] to-white to-90% blur-3xl opacity-70" />

        <div className="absolute pointer-events-none -left-[25%] top-1/4 size-[50%] rounded-full bg-radial radial-[at_50%_75%] from-[#95E4FA] to-white to-90% blur-3xl opacity-70" />

        <div className="absolute pointer-events-none left-[20%] lg:left-[10%] -top-[1%] size-[50%] rounded-full bg-radial radial-[at_50%_75%] from-[#8193E5] to-white to-90% blur-3xl opacity-70" />
