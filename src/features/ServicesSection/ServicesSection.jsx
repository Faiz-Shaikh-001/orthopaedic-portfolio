...
const ServicesContent = ({ content }) => {
  ...
  return (
    <section
      className="relative w-full lg:-mt-40 scroll-smooth"
      id="Services"
    >
      ...
      >
        ...
        <div className="absolute pointer-events-none -right-[25%] top-[50%] lg:top-1/4 size-[50%] rounded-full bg-radial radial-[at_50%_75%] from-[#88CEC2] to-[#0F5B81] to-90% blur-3xl opacity-40" />

        <div className="absolute pointer-events-none -left-[25%] top-[50%] lg:top-1/4 size-[50%] rounded-full bg-radial radial-[at_50%_75%] from-[#88CEC2] to-[#0F5B81] to-90% blur-3xl opacity-40" />
      ...
      <div
        className="lg:p-50 relative z-10"
        ref={containerRef}
      >
...
const ServiceCard = memo(
  ({
    ...
    >
      ...
      <IconComponent className="w-16 h-16 mb-3 text-[#09A1CB]" />
