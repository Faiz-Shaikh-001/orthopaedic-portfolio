...
const AchievementsContent = ({ content }) => {
  const {
    heading,
    sub_text = "",
    cards = [],
  ...
  return (
    ...
    >
      ...
      >
        ...
        <AchievementIcon
          className="absolute h-30 w-fit rotate-20 left-[10%] leftIconAnim"
          aria-hidden="true"
        />

        <MedalIcon
          className="absolute h-40 w-fit -rotate-20 right-[10%] top-[10%] rightIconAnim"
          aria-hidden="true"
        />

        <MedicalCareHandsIcon
          className="absolute h-90 w-fit rotate-20 right-[1%] top-[70%] rightIconAnim"
          aria-hidden="true"
        />
